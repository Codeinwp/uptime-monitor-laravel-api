<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><meta name="format-detection" content="telephone=no"><title></title><link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet" type="text/css"><link href="https://fonts.googleapis.com/css?family=Ubuntu" rel="stylesheet" type="text/css"><link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet" type="text/css"><style type="text/css">
        /* Resets */
    ...
    }@media screen{body{font-family:'Roboto','Arial',Helvetica,sans-serif;}}@media screen{body{font-family:'Ubuntu','Arial',Helvetica,sans-serif;}}@media screen{body{font-family:'Montserrat','Arial',Helvetica,sans-serif;}}</style><!--[if gte mso 11]><style type="text/css">table{border-spacing: 0; }table td {border-collapse: separate;}</style><![endif]--><!--[if !mso]><!--><style type="text/css">table{border-spacing: 0;} table td {border-collapse: collapse;}</style> <!--<![endif]--><!--[if gte mso 15]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]--><!--[if gte mso 9]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]--> </head><body>
...
<table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" class="main-template" bgcolor="#f9fafc" style="background-color:#f9fafc;">
    ...
    <tr>
                                                ...
                                                <table cellpadding="0" border="0" align="center" cellspacing="0" class="logo-img-center"> 
                                                    <tbody><tr>
                                                        <td valign="middle" align="center">
                                                            <div style="border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;display:inline-block; " cellspacing="0" cellpadding="0" border="0"><a style="text-decoration:none;" target="_blank" href="https://themeisle.com/plugins/orbit-fox-companion/"><div><img width="75" vspace="0" hspace="0" border="0" alt="OrbitFox" style="float: left;max-width:75px;" class="rnb-logo-img" src="http://img.mailinblue.com/1002404/images/rnb/original/5a86bc32e694aa13f109a556.png"></div></a>
                                                            </div></td>
                                                    </tr>
                                                </tbody></table>
                                                </td>
        ...
        <td align="center" valign="top" bgcolor="#f9fafc" style="background-color:#f9fafc;">
            ...
            <table width="100%" cellpadding="0" border="0" cellspacing="0" bgcolor="#f9fafc" style="background-color:#f9fafc;" name="Layout_6" id="Layout_6"><tbody><tr>
                                ...
                                <td class="rnb-container-padding" bgcolor="#ffffff" style="background-color: #ffffff; font-size: px;font-family: ; color: ;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="rnb-columns-container" align="left" style="margin:auto;">
                                        <tbody><tr>
                                            ...
                                            <td class="rnb-force-col" align="left">
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                    ...
                                                    <tr>
                                                        <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:left;">
                                                            ...
                                                            <span style="color:#3c4858;"><span style="font-size:13px;">Hi,<br><br>
{{-- Intro Lines --}}
...
<br/> 
<br/> 
OrbitFox will alert you when it is back up.<br>
&nbsp;</span></span> 
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <table width="590" class="rnb-container rnb-yahoo-width" cellpadding="0" border="0" align="center" cellspacing="0" style="padding-right:20px; padding-left:20px;">
                            ...
                            <tr>
                                <td style="font-size:14px; color:#888888; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;">
                                    <div><div>© 2018 OrbitFox - A product by <a href="https://themeisle.com">ThemeIsle.com</a></div>
</div>
                                </td></tr>
                            <tr>
                                <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
